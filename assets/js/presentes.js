...
if (purchaseGrid && reservationGrid) {
  ...
  const purchaseGifts = [
    {
      id: "gym-annual",
      image: "./assets/images/gifts/purchase/honeymoon-shape-gym-user.webp",
      title: "Academia para os noivos entrarem no shape depois da lua de mel",
      price: "R$ 2.388,00",
    },
    {
      id: "helmet-against-rolling-pin",
      image: "./assets/images/gifts/purchase/helmet-against-rolling-pin-user.webp",
    ...
    {
      id: "therapy-retreat",
      image: "./assets/images/gifts/purchase/therapy-retreat.webp",
      title: "Retiro anti-DR premium para o casal respirar fundo e continuar se amando",
      price: "R$ 1.480,00",
    },
    {
      id: "snore-proof",
      image: "./assets/images/gifts/purchase/snore-proof-user.webp",
      title: "Kit de sobrevivência para ronco matrimonial com tecnologia e paciência",
      price: "R$ 1.189,00",
    },
    {
      id: "luxury-massage",
      image: "./assets/images/gifts/purchase/luxury-massage-user.webp",
    ...
    {
      id: "bride-alarm",
      image: "./assets/images/gifts/purchase/bride-alarm-user.webp",
      title: "Despertador da Noiva (Necessario)",
      price: "R$ 69,90",
    },
    {
      id: "bride-makeup",
      image: "./assets/images/gifts/purchase/bride-makeup-user.webp",
      title: "Ajuda com a make da noiva",
      price: "R$ 579,90",
    },
    {
      id: "white-dress-pass",
      image: "./assets/images/gifts/purchase/white-dress-pass-user.webp",
      title: "Vale ir de Branco pro casamento",
      price: "R$ 10.000,00",
    },
    {
      id: "buffet-first-pass",
      image: "./assets/images/gifts/purchase/buffet-first-pass-user.webp",
      imageFit: "contain",
    ...
    {
      id: "custom-gift",
      image: "./assets/images/gifts/purchase/custom-gift-user.webp",
  ...
  const reservationGifts = [
    ...
    { id: "storage-bed", image: "./assets/images/gifts/purchase/bed-linen.webp", title: "Cama com Baú", quantity: 1 },
